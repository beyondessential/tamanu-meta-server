...
## Migration testing in the RC cycle · V1
...
## Settle deployment, group, and rank terminology · W1
...
## Canopy holds inventory state · X1
...
## Audit the release and RC process · Y1
...
## Canopy quick-wins sweep and bug audit · A2
...
## Ansible plugin making Canopy the inventory source · B2
...
## Canopy refusing to serve inventory, with concurrency as the first policy · C2
