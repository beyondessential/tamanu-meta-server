...
An application-scoped issue belongs to the environment its application is in: the one its rank names, or its group's headline environment where the application carries no rank.
