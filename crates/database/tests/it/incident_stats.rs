	...
	commons_tests::db::TestDb::run(async |mut conn, url| {
		...
		conn.batch_execute(&format!(
			"INSERT INTO devices (id, role) VALUES ('{device_id}', 'server'); \
			 ...
			 WITH m AS (INSERT INTO machines (id, group_id) VALUES ('{server_id}', '{group_id}') RETURNING id) INSERT INTO applications (id, host, kind, device_id, group_id, machine_id) VALUES \
