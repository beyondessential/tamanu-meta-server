...
ALTER TABLE server_reported_detail ADD COLUMN version_reported_at TIMESTAMPTZ;
UPDATE server_reported_detail SET version_reported_at = reported_at WHERE version IS NOT NULL;
