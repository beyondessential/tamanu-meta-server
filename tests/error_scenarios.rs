...
async fn public_status_invalid_server_id() {
...
#[tokio::test(flavor = "multi_thread")]
async fn public_status_nonexistent_server_id() {
	test_server::run(async |_conn, public, _| {
...
#[tokio::test(flavor = "multi_thread")]
async fn public_status_missing_auth_headers() {
...
#[tokio::test(flavor = "multi_thread")]
async fn public_versions_invalid_version_format() {
	test_server::run(async |_conn, public, _| {
...
#[tokio::test(flavor = "multi_thread")]
async fn public_versions_negative_version() {
	test_server::run(async |_conn, public, _| {
...
#[tokio::test(flavor = "multi_thread")]
async fn public_versions_create_without_auth() {
	test_server::run(async |_conn, public, _| {
...
#[tokio::test(flavor = "multi_thread")]
async fn public_versions_delete_without_auth() {
	test_server::run(async |mut conn, public, _| {
...
#[tokio::test(flavor = "multi_thread")]
async fn public_artifacts_create_without_auth() {
	test_server::run(async |mut conn, public, _| {
		// Create a version first
		conn.batch_execute(
			"INSERT INTO versions (major, minor, patch, changelog, published) VALUES (1, 0, 0, 'Test version', true)",
...
#[tokio::test(flavor = "multi_thread")]
async fn public_artifacts_invalid_version() {
	test_server::run(async |_conn, public, _| {
...
#[tokio::test(flavor = "multi_thread")]
async fn public_versions_update_for_invalid_version() {
	test_server::run(async |_conn, public, _| {
...
#[tokio::test(flavor = "multi_thread")]
async fn public_timesync_invalid_request() {
	test_server::run(async |_conn, public, _| {
...
#[tokio::test(flavor = "multi_thread")]
async fn public_timesync_oversized_request() {
	test_server::run(async |_conn, public, _| {
...
#[tokio::test(flavor = "multi_thread")]
async fn public_error_empty_slug() {
	test_server::run(async |_conn, public, _| {
...
#[tokio::test(flavor = "multi_thread")]
async fn public_versions_sequential_access() {
	test_server::run(async |mut conn, public, _| {
		// Create a version
		conn.batch_execute(
			"INSERT INTO versions (major, minor, patch, changelog, published) VALUES (1, 0, 0, 'Test version', true)",
...
#[tokio::test(flavor = "multi_thread")]
async fn public_malformed_json_body() {
	test_server::run(async |mut conn, public, _| {
...
#[tokio::test(flavor = "multi_thread")]
async fn public_missing_content_type() {
	test_server::run(async |_conn, public, _| {
